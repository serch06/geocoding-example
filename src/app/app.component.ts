        ...
        this.geocodingService
          ...
          .then((response: GeocoderResponse) => {
            if (response.status === 'OK' && response.results?.length) {
              console.log("Resultados getCurrentLocation: ", response.results);
      ...
      .subscribe(
        (response: GeocoderResponse) => {
          if (response.status === 'OK' && response.results?.length) {
            ...
            console.log("Resultados findAddress: ", response.results);
            ...
            // This is to make sure the app has enough time to update before we center the map on the new coordinates.
            setTimeout(() => {
